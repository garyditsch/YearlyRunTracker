...
})({"b32iK":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7eada9348bdcd5f5";
...
getWeeklyData().then((response)=>{
    ...
    const weeklyFortyFiveArray = response.map((x)=>{
        return x.runsOverFortyFive;
    });
    ...
    const myWeeklySuccessChart = new Chart(document.getElementById('myWeeklySuccessChart'), config);
}).catch((err)=>console.log(err)
);
...
//# sourceMappingURL=weekly.8bdcd5f5.js.map
