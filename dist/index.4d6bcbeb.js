...
_calendarJs.calendar(theData, runTable, calendar_svg_2021, {
...
_calendarJs.calendar(theData, runTable, calendar_svg_2020, {
...
const getMonthlyGroupedData = async (runTable1, runTable21, isSorted)=>{
    ...
    const monthLabels = await result.map((x)=>{
        return x.key;
    });
    const monthRunCount = await result.map((x)=>{
        return x.runCount;
    });
    return {
...
},{"./modules/calendar.js":"4hFy1","./modules/helpers.js":"24ohu"}],"4hFy1":[function(require,module,exports) {
...
},{}],"24ohu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./calendar.js":"4hFy1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fcvSp","gLLPy"], "gLLPy", "parcelRequire50e8")
